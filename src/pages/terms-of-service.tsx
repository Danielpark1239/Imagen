...
const TermsOfService: NextPage = () => {
  return (
    <>
      ...
      <main>
        <Navbar />
        <div className="mt-32 flex flex-col gap-4 px-16 text-black">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Imagen.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Imagen, accessible from{" "}
                <a target="_blank" href="/">
                  imagen-danielpark1239.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <h2 className="mt-2 text-2xl font-semibold">Acknowledgment</h2>
          <p>
          ...
          <p>
            We can use your icons to promote our service. This includes, but is
            not limited to: online ads, physical ads, social media posts, and
            anywhere inside this application.
          </p>
          ...
          <p>
            Our service uses AI provided by OpenAI to generate icons. Please
            review copyright laws for your country and state in regards to AI
            generated art or images. By using our services, you agree that our
            company and service assumes no responsibility for the images
            generated. Nor do we assume responsibility for damages or loss
            caused by these images.
          </p>
          <p>
          ...
          <h2 className="text-xl font-semibold">Disputes Resolution</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold">Translation Interpretation</h2>
          <p>
          ...
          <ul className="mb-8">
            <li>By email: danielpark1239@gmail.com</li>
          </ul>
        </div>
        <Footer />
      </main>
