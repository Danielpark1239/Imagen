      ...
      <main>
        ...
        <div className="mt-32 flex flex-col gap-4 px-16 text-black">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Imagen, accessible
                from{"imagen-danielpark1239.vercel.app"}
          ...
          <h2 className="text-2xl font-semibold mt-2">Collecting and Using Your Personal Data</h2>
